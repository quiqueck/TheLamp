...
static CRGB* __leds[LEDState::LayerTypeCount] = {(CRGB*)__b0, (CRGB*)__b1, (CRGB*)__b2, (CRGB*)__b3, (CRGB*)__b4};
static float* __ledsAlpha[LEDState::LayerTypeCount] = {(float*)__a0, (float*)__a1, (float*)__a2, (float*)__a3, (float*)__a4};
